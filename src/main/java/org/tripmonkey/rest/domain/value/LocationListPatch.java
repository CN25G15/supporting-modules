...
public class LocationListPatch extends WorkspacePatch<LocationListDTO> implements PatchVisitor  {

    public LocationListPatch(String wid, String uuid, Op op, PathNode path, LocationListDTO value) {
